...
/**
 * The comparator item transformer tests.
 *
...
public class ComparatorItemTransformerTests {
  ...
  /**
   * Create comparator item deserializer and serializer.
   */
  @Before
  ...
  /**
   * Test concatenated comparator items.
   */
  @Test
  ...
  /**
   * Test simple comparator item without order.
   */
  @Test
  ...
  /**
   * Test concatenated comparator items without order.
   */
  @Test
